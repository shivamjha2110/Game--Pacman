...
def won(dur,score):
	message("GAME OVER",(160,160),(0,255,0),50)
	message("Your Time: "+str(dur)+"s",(160,200),(255,0,0),20)
	message("Your Score: "+str(score),(160,230),(0,0,255),20)
	message("Exiting in 5 seconds",(160,300),(255,255,255),15)
	time.sleep(5)
	exit()
...
pygame.display.set_caption('PACMAN LEVEL 1')	#Game Window Title
...
pose=[(1,8),(8,8)]	#Initial position of enemies
ne=2	#No. of enemies
...
while True:
	...
	if 'c' not in layout: #If all coins gone
		...
		message("Time: "+str(dur),(260,10),(255,0,0),20)	#Display time from start in seconds
