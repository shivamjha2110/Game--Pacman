...
def won(dur,score):
	message("GAME OVER",(640,320),(0,255,0),50)
	message("Your Time: "+str(dur)+"s",(640,380),(255,0,0),20)
	message("Your Score: "+str(score),(640,420),(0,0,255),20)
	message("Exiting in 5 seconds",(640,500),(255,255,255),15)
	time.sleep(5)
	exit()

#Draws a RED coloured rectangle for the enemy
...
pygame.display.set_caption('PACMAN LEVEL 3')	#Game Window Title
background = pygame.surface.Surface((1280,640)).convert()
...
pose=[(38,1),(38,18),(1,18),(22,8),(15,14),(8,8),(15,1)]	#Initial position of enemies
ne=7	#No. of enemies
...
while True:
	...
	if 'c' not in layout: #If all coins gone
		...
		message("Time: "+str(dur),(1200,10),(255,0,0),20)	#Display time from start in seconds
